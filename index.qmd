...
#| cache: true
#| out-width: "80%"
#| fig-cap: DGPs for the conditional density simulations (top Beta, bottom Gaussian, figures on the left $X$ irrelevant, figures on the right $X$ quadratic)
theta <- 110
phi <- 50
...
-   We compare the performance of the proposed method using empirical bounds with the methods of @HALL_RACINE_LI:2004 and @fyt:1996, which use a classical kernel presuming infinite support (inappropriate for the Beta).
    ...
    #| tbl-cap: Median Relative RMSE Irrelevant
    ...
    #| tbl-cap: Median Relative RMSE Quadratic
