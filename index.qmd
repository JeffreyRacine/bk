...
-   I am aiming for an interactive seminar format, which will require either your participation or being seated next to someone who is
...
-   If you have R/RStudio and the libraries installed, we can work with the methods and data interactively.

-   My hope is that you will be able to follow along and reproduce the results on your own computer.

-   Let's begin by opening the following link in Firefox: [https://jeffreyracine.github.io/bk](https://jeffreyracine.github.io/bk)
...
-   Software written in R is available at:  [https://github.com/JeffreyRacine/bkcde](https://github.com/JeffreyRacine/bkcde)
...
-   Regarding the use of boundary kernels, @SCOTT:1992, Page 149, notes:
